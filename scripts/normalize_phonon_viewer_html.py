...
STYLE_BLOCK = """<style>
  ...
  #container { position: relative; width: 100vw; height: 100vh; background: radial-gradient(circle at top, #ffffff 0%, #f8fafc 42%, #e2e8f0 100%); }
...
SCRIPT_TAIL = """var viewer = $3Dmol.createViewer("viewer", {backgroundColor: "0xf1f5f9"});
