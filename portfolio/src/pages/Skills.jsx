...
const figures = [
  ...
  { src: '/figures/sige-diffusivity.png', num: 'Fig. 05', label: 'SiGe Diffusivity', caption: 'Thermal diffusivity of amorphous silicon–germanium alloys. The large shaded areas represent the mean value of specific groups of frequencies.', span: 'wide' },
  { src: '/figures/mgo-disp.png', num: 'Fig. 06', label: 'MgO Phonon Dispersion', caption: 'Phonon Dispersion for Magnesium Oxide that shows off one of the features I added to kALDo, the non-analytical correction. In real materials with a dipole, the transverse and longitudinal optical modes typically split near Gamma, demonstrated by the red lines.', span: 'wide' },
  { src: '/figures/mgo-props.png', num: 'Fig. 07', label: 'MgO Thermal Properties', caption: 'Phonon properties of MgO with and without the NAC correction. Adding the correction decreases optical modes group velocities and lower the thermal conductivity.', span: 'wide' },
  { src: '/figures/sige-velocities.png', num: 'Fig. 08', label: 'SiGe Phonon Velocities', caption: 'Effects of alloy concentration in the generalized group velocities of phonon modes. The 2D grid represents the effects of the interactions with each pair of modes. Generalized quantities are the cornerstone of QHGK, where we lose focus on individual modes, and instead couple them.', span: 'standard' },
...
const Skills = () => {
  ...
  return (
    <div className="skills-page">
      ...
      {/* \u2500\u2500 \u00a7 00 Data Analysis + Visualization \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */}
      <section className="skills-section" id="visualization">
        <SectionDivider num="00" title="Data Analysis + Visualization" />
        <p className="skills-section-intro">
          ...
          I hope to show that I enjoy making high quality scientific figures that communicate
      ...
      <section className="skills-section" id="software">
        <SectionDivider num="02" title="Scientific &amp; Technical Software" />
        <p className="skills-section-intro">
